...
{(order.payment === 'NayaPay' || order.payment === 'COD') && order.bankTransferProofBase64 && (
      <div className="mt-2">
    <strong>{order.payment === 'NayaPay' ? 'NayaPay Transaction Proof:' : 'Advance Payment Proof:'}:</strong>
        <div
